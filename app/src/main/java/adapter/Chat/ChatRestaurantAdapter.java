...
public class ChatRestaurantAdapter extends RecyclerView.Adapter<ChatRestaurantAdapter.MyViewHolder> {

    private List<ChatList> chatList;
    private Context context;

    public ChatRestaurantAdapter(List<ChatList> chatList, Context context) {
    ...
    @NonNull
    @Override
    public ChatRestaurantAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
